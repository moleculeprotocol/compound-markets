...
import "../registries/Parameterizer.sol";
import "plcr-revival/PLCRVoting.sol";
import "zeppelin/math/SafeMath.sol";

import "./CompoundNFTFactory.sol";
...
contract EntryTCR {
    ...
    // Notes: Why are these public and not set in a constructor
    // Global Variables
    ...
    CompoundNFTFactory public factory;

    /**
    @dev Initializer. Can only be called once.
    @param _token The address where the ERC20 token contract is deployed
    */
    function init(address _token, address _voting, address _parameterizer, address _factory, string _name) public {
        ...
        factory = CompoundNFTFactory(_factory);
        name = _name;
    }
